...
class Router {
    ...
    change(method, _url, _as, options) {
        return new Promise((resolve, reject) => {
            ...
            // If the url is a change just to query params with no redraw needed do the following
            if (!options._h && options.shouldNotRedraw) {
              this.changeState(method, url, addBasePath(_as), options);
              return resolve(true);
            }
